...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<title>Classic Car Collection - Cars Enciclopedia</title>	
...
<body>
    ...
    <div align="right" >
        <asp:LinkButton ID="LinkButton4" runat="server" 
            onclick="LinkButton4_Click" ForeColor="Black">Purchase a Car</asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
	
	
		
		<div class="section clearfix">
			<h1>Cars Encyclopedia</p>
		</div>
		...
		<div class="section all-small clearfix articles">
			<div>
				...
				<p><strong>You are</strong>welcome to John's Pld Car and Truck Pictures. If you like the antique and vintage old cars and trucks then you...</p>
			...
			<div>
				...
				<p><strong>Bob's site</strong> of Old Cars and Trucks contains some of the most CLASSY cars and trucks ofall teh time. This site is having more than... </p>
				<a class="more button" href="#">read more</a>
			</div>
			...
			<div>
				...
				<p><strong>So many</strong> these pictures of cars and trucks on this site came from the news groups, so there may be a chance that your car is shown...</p>
				<a class="more button" href="#">read more</a>
			</div>
			...
			<div>
				...
				<p><strong>In the year</strong> of 1955 so many dramatic changes is done in the body design of Chervolet to make the designs more popular to public</p>
				<a class="more button" href="#">read more</a>
			</div>
		...
		<div class="section all-small clearfix articles">
			<div>
				...
				<div class="info"><a href="#">Blog</a>, <a href="#">Features</a> <span>| 3 Comments</span></div>
				<div class="imgLarge wd205">
					<img width="175" height="230" src="images/light/slices/article_image_11.jpg" alt="" />
				</div>
				<p><strong>In</strong> 1955 a legendry small blok V 8 was introduced by Chervolet to the buying public. A new engine is used in this model.</p>
				<a class="more button" href="#">read more</a>
			</div>
			...
			<div>
				<h2><a href="#">Enzo Ferrari's new master piece</a></h2>
				<div class="info"><a href="#">Blog</a>, <a href="#">cars</a>, <a href="#">ferrari</a> <span>| 3 Comments</span></div>
				<div class="imgLarge wd205"><img width="175" height="230" src="images/light/slices/article_image_16.jpg" alt="" /></div>
				<p><strong>In the</strong> year 1955 there were versions rated at from 162 hp to 180 hp using an optional 4 barrel carb and dual exhaust....</p>
				<a class="more button" href="#">read more</a>
			</div>
			...
			<div>
				...
				<div class="info"><a href="#">Cars</a>, <a href="#">engines</a> <span>| 8 Comments</span></div>
				<div class="imgLarge wd205">
					<img width="175" height="230" src="images/light/slices/article_image_15.jpg" alt="" />
				</div>
				<p><strong>Because of</strong> the changes made in the design in the year 1955, the sales of cars set record for he next three years. At this very time..</p>
				<a class="more button" href="#">read more</a>
			</div>
			...
			<div>
				<h2><a href="#">New fuel brings 20% speed</a></h2>
				<div class="info"><a href="#">Cars</a>, <a href="#">Fuels</a> <span>| 12 Comments</span></div>
				<div class="imgLarge wd205"><img width="175" height="230" src="images/light/slices/article_image_17.jpg" alt="" /></div>
				<p><strong>Look and </strong>use of the station wagon was changed forever.They were modern,F resh, they were clean and they were CHEVROLETS.</p>
				<a class="more button" href="#">read more</a>
			</div>
		...
		<div class="section all-small clearfix articles">
			<div>
				...
				<div class="info"><a href="#">Blog</a>, <a href="#">Features</a> <span>| 3 Comments</span></div>
				<div class="imgLarge wd205">
					<img width="175" height="230" src="images/light/slices/article_image_31.jpg" alt="" />
				</div>
				<p><strong>This engine</strong> V 8 developed by Chervolet in the year 1955 was to become the most famous Chevrolet engine of all the times...</p>
				<a class="more button" href="#">read more</a>
			</div>
			...
			<div>
				<h2><a href="#">Enzo Ferrari's new master piece</a></h2>
				<div class="info"><a href="#">Blog</a>, <a href="#">cars</a>, <a href="#">ferrari</a> <span>| 3 Comments</span></div>
				<div class="imgLarge wd205"><img width="175" height="230" src="images/light/slices/article_image_32.jpg" alt="" /></div>
				<p><strong>These 3</strong> model produced the best looking Chevy's of all time & did more to change the way North America looked at automobile</p>
				<a class="more button" href="#">read more</a>
			</div>
			...
			<div>
				...
				<div class="info"><a href="#">Cars</a>, <a href="#">engines</a> <span>| 8 Comments</span></div>
				<div class="imgLarge wd205">
					<img width="175" height="230" src="images/light/slices/article_image_33.jpg" alt="" />
				</div>
				<p><strong>The 1953</strong> Chevrolet automobile came in three basic body styles. The 1500 and 2100 series continue from the previous years</p>
				<a class="more button" href="#">read more</a>
			</div>
			...
			<div>
				<h2><a href="#">New fuel brings 20% speed</a></h2>
				<div class="info"><a href="#">Cars</a>, <a href="#">Fuels</a> <span>| 12 Comments</span></div>
				<div class="imgLarge wd205"><img width="175" height="230" src="images/light/slices/article_image_34.jpg" alt="" /></div>
				<p><strong>The New </strong>the new BelAir or 2400 Series is new for the 1953 Chevrolet models. Because the name BelAir,now applies to series</p>
				<a class="more button" href="#">read more</a>
			</div>
	...
	<div id="footer" class="clearfix">
		...
		<div class="section all-medium style-classic">
			...
			<div class="custom-tiny">
				...
				<p><strong>The no</strong> is increasing rapidly,especially in China and India.</p>
				<div class="img sptb wd130"><img src="images/light/slices/image-anton.png" alt="" /></div>
				<p>In the world, there were about 806 million cars</p>
				<a href="#" class="more">read more</a>
			</div>
			
			<div class="custom-tiny">
				<h3>Jenson Button</h3>
				<p><strong>There are</strong> approximately 600 million passenger... </p>
				<div class="img sptb wd130"><img src="images/light/slices/image-nicolae.png" alt="" /></div>
				<p>They burn over 1 billion m³ of petrol/gasoline</p>
				<a href="#" class="more">read more</a>
			</div>

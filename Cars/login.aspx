...
<body>
	...
	<div id="footer" class="clearfix">
        ...
        <asp:TextBox ID="TextBox2" TextMode="Password" runat="server" ForeColor="Black"></asp:TextBox>
        &nbsp;</div>					
		<br/>			
		<div>
        <asp:Button ID="bt_login" runat="server" Text="Login" 
                onclick="bt_login_Click" Width="80" CssClass="form-button" 
                Font-Bold="True" Font-Size="Small" />
		</div><br/><a href="register.aspx"><font color="black">Register</font></a></div>
		</div> <!--Footer content -->
		</div>
		<!-- Footer styler -->
